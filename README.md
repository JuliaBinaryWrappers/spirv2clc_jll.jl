# `spirv2clc_jll.jl` (v0.2.0+0)

[![deps](https://juliahub.com/docs/spirv2clc_jll/deps.svg)](https://juliahub.com/ui/Packages/General/spirv2clc_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/32203720caa1b5008b5771d46b6e694624443b3c/S/spirv2clc/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `spirv2clc_jll.jl` have been built from these sources:

* git repository: https://github.com/JuliaGPU/spirv2clc (revision: `e2819b5305bef915b7350fa773f8349df7b44aa7`)

## Platforms

`spirv2clc_jll.jl` is available for the following platforms:
